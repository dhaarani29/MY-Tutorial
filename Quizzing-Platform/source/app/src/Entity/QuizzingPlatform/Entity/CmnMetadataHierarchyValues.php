...
/**
 * CmnMetadataHierarchyValues
 *
 * @ORM\Table(name="cmn_metadata_hierarchy_values", indexes={@ORM\Index(name="fk__metadata_hierarchy_values__metadata_idx", columns={"metadata_id"})})
 * @ORM\Entity
 */
class CmnMetadataHierarchyValues
{
    /**
     * @var integer
     *
     ...
     *
     * @return CmnMetadataHierarchyValues
     */
