(function() {
    ...
    angular.module('eupapp')
        ...
        .run(['$rootScope', '$state', '$stateParams', '$urlRouter', '$window', '$location', '$localStorage', '$http', function($rootScope, $state, $stateParams, $urlRouter, $window, $location, $localStorage, $http) {
